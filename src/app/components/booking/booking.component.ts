    ...
    if(this.vehicleTypeId==-1){
      ...
      if(this.selectedPayment){
        ...
        if(this.selectedPayment["value"]=="Point"){
          ...
          console.log(this.auth.getUserFromLocalCache().point);
          if(this.auth.getUserFromLocalCache().point<(this.vehicleTypes.find(x=>x.id==this.vehicleTypeId).point*this.distanceAmount)){
