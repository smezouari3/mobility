...
export class ContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(private route: ActivatedRoute,private router:Router, public navServices: NavService,
    public layout: LayoutService, public authService: AuthenticationService) {
      if(this.authService.isUserLoggedIn()==true)
      {
        if(this.authService.getUserFromLocalCache().role!='ROLE_USER' && this.authService.getUserFromLocalCache().role!='ROLE_DRIVER'){
