...
import { FooterFullComponent } from './components/full/footer-full/footer-full.component';
import { HeaderFullComponent } from './components/full/header-full/header-full.component';
import { TheAccountComponent } from './components/full/header-full/elements/the-account/the-account.component';
